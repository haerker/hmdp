...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result sign() {
        ...
        String keyPer = now.format(DateTimeFormatter.ofPattern(":yyyyMM"));
        String key = USER_SIGN_KEY + userId + keyPer;
        int index = now.getDayOfMonth();
        stringRedisTemplate.opsForValue().setBit(key, index - 1, true);
        return Result.ok();
    }
